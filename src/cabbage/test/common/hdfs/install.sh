...
#sudo cp ~/cabbage_install/phantomjs-2.1.1-linux-x86_64/bin/phantomjs /usr/bin
...
sudo pip install -i https://pypi.douban.com/simple --upgrade celery
...
sudo pip install -i https://pypi.douban.com/simple --upgrade kombu
